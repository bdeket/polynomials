...
(define #:forall (A B)(root-bisect [alg : (Algebra (∩ Real A))]
                                   [P : (Poly (∩ Real A B))]
...
(module+ test
  ...
  (define R1 ((inst root-bisect Exact-Rational Integer)
             Q-algebra P1 (list 0 21/10)))
  (print-iteration-result R1)(newline)
  
  (define P2 (make-poly I-algebra '(((2)1)((0)-1))))
  (define R2 ((inst root-bisect Real Integer) R-algebra P2 (list 0 2.1)))
  (print-iteration-result R2)(newline)
  
  (define P3 (make-poly I-algebra '(((2)-1)((0)1))))
  (define R3 ((inst root-bisect Real Integer) R-algebra P3 (list 0 10000000000000000000000000)))
  (print-iteration-result R3)(newline)
  
  (define P4 (make-poly I-algebra '(((2)-1)((0)0))))
  (define R4 ((inst root-bisect Real Integer) R-algebra P4 (list -101 100)))
